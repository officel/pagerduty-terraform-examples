...
- [技術書典 16](https://techbookfest.org/event/tbf16) - PagerDuty ファンブック vol.1 - PagerDuty &amp; Terraform のサンプルリポジトリ
- [技術書典 19](https://techbookfest.org/event/tbf19) - PagerDuty ファンブック vol.2 - PagerDuty &amp; Terraform のサンプルリポジトリ
...
- [terraform のバージョンマネージャー選び](https://zenn.dev/terraform_jp/articles/2024-08-22_terraform_version_manager) という記事を書いた
